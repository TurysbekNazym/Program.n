   ...
   public class Snake:Drawer
    {
        ...
        public void move(int dx, int dy)
        {
            ...
            // так как размер консола 40,40
            if (body[0].x + dx < 0) dx = dx + 40;//сол жактан шыгып кетсе он жактан шыгады
            if (body[0].y + dy < 0) dy = dy + 40;// жогаргы жактагы шекарадын отсе томеннен шыгады
            if (body[0].x + dx > 24) dx = dx - 40;// он жактан шыкса сол жактан келеди
            if (body[0].y + dy > 24) dy = dy - 40;// томеннен шыкса жогарыдан келеди
